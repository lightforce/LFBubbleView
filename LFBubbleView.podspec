Pod::Spec.new do |s|
  ...
  s.source_files = 'LFBubbleView/LFBubbleCollectionViewCell.{h,m}', 'LFBubbleViewLFBubbleCollectionView.{h,m}', 'LFBubbleViewLFBubbleCollectionViewController.{h,m}', 'Pods/NHAlignmentFlowLayout/NHAlignmentFlowLayout/NHAlignmentFlowLayout.{h,m}'
  s.requires_arc = true
end
